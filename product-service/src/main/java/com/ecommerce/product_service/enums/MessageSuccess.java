...
public enum MessageSuccess {
    ...
    CATEGORY_CREATED_BULK_SUCCESSFULLY("Category created bulk successfully."),
    ...
    CATEGORY_UPDATED_BULK_SUCCESSFULLY("Category updated bulk successfully."),
    CATEGORY_DELETED_SUCCESSFULLY("Category deleted successfully."),
    CATEGORY_DELETED_BULK_SUCCESSFULLY("Category deleted bulk successfully."),
    STATUS_TRANSITION_SUCCESSFULLY("Status transition successfully."),
    ...
    BRAND_CREATED_BULK_SUCCESSFULLY("Brand created bulk successfully"),
    BRAND_UPDATED_BULK_SUCCESSFULLY("Brand updated bulk successfully"),
    BRAND_DELETE_BULK_SUCCESSFULLY("Brand deleted bulk successfully"),
